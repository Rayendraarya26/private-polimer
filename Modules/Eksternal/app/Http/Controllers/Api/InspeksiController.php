    ...
    public function store(Request $request): JsonResponse
    {
        ...
        try {
            ...
            $formInspeksi = FormInspeksi::create([
                ...
                'komoditas' => $dataSpesifikasi['komoditas'] ?? 'Karung Plastik Beras Bantuan Pangan',
                'kapasitas_karung' => $dataSpesifikasi['kapasitas_karung'] ?? '10 kg',
                ...
                'penerima_hasil_nama' => $dataPenerima['penerima_hasil_nama'] ?? 'Perum BULOG',
