        ...
        <div class="card-body p-5">
            <div class="d-flex flex-column gap-5">
                ...
                <div class="d-flex justify-content-end">
                    <button type="button" class="btn btn-light-primary me-5" id="refresh">
                        <i class="fa-duotone fa-arrow-rotate-left ms-2"></i>
                        Refresh
                    </button>
                ...
                <div class="modal-content rounded">
                    ...
                    <div id="approvalFormSection">
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            ...
                            {{-- Info identitas --}}
                            <div
                                class="notice d-flex bg-light-primary rounded border-primary border border-dashed p-6 mb-7">
