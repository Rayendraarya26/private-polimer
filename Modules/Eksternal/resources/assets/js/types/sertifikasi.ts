...
export const defaultDokumenList: DokumenPersyaratanItem[] = [
  {
    id: "surat_permohonan",
    nama: "Surat Permohonan Sertifikasi",
    keterangan: "Surat permohonan resmi bertandatangan pimpinan (format template tersedia)",
    wajib: true,
    file: null,
  ...
  },
  {
    ...
    nama: "Akta Pendirian & SK Kemenkumham",
    keterangan: "Dokumen legalitas badan hukum (auto-populate dari profil)",
    wajib: true,
    file: null,
  },
  {
    id: "nib_iui",
    nama: "NIB / Izin Usaha Industri (IUI)",
    keterangan: "Nomor Induk Berusaha dengan KBLI yang sesuai (auto-populate dari profil)",
    wajib: true,
    file: null,
  },
  {
    id: "sertifikat_merek",
    nama: "Sertifikat Merek / Tanda Daftar DJKI",
    keterangan: "Bukti kepemilikan merek atau surat pelimpahan merek dari pemilik hak",
    wajib: true,
    file: null,
  },
  {
    id: "sistem_mutu",
    nama: "Manual Mutu / Prosedur Mutu",
    keterangan: "Pedoman mutu ISO 9001 / manual sistem manajemen yang diterapkan",
    wajib: false,
    file: null,
  ...
  {
    id: "alur_produksi",
    nama: "Diagram Alir Proses & Denah Lokasi Pabrik",
    keterangan: "Diagram alir pembuatan produk dan denah fasilitas unit produksi",
    wajib: false,
    file: null,
  },
  {
    ...
    keterangan: "Daftar peralatan uji laboratorium, sertifikat kalibrasi, atau dokumen pendukung",
    wajib: false,
    file: null,
  },
]
