...
<div class="card">
	...
	<div class="card-header">
		<!--begin::Card header-->
		<div class="card-title fs-3 fw-bold">File Sertifikat</div>
		<!--end::Card header-->
	</div>
	<!--end::Card header-->
	<div class="card-body row">
		@foreach($data_detail as $data_file)
		<div class="col-md-3 mb-4">
			<a href="{{ url($url."/".$data->id."/download-certificate?kode=".$data_file['kode']) }}" target="_blank">
				<div class="card card-hover">
					<div class="card-header mx-4 p-5 d-flex flex-row justify-content-center">
						<svg fill="#000000" height="40" width="35" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
					...
					<div class="card-body pt-5 p-3 text-center">
						<h6 class="text-center mb-0">
						{{ $data_file['nama'] }}
						</h6>
						<div class="mb-0">
							<span class="btn btn-default"
								  style="width: 100%"><i class="fad fa-download"></i> &nbsp; Download</span>
						</div>
					</div>
				</div>
			</a>
